...
class Sidebar extends React.Component {
    ...
    routeActive(paths) {
        ...
        for (const p in paths) {
            if (this.context.router.isActive(String(paths[p])) === true)
                return 'active'
        }
        return ''
    }
                        ...
                        <ul>
                            ...
                            >
                                ...
                                <ul id="pages" className="sidebar-subnav">
                                    <li
                                        className={this.routeActive('timeline')}
                                    >
                                        <Link
                                            to="pages/timeline"
                                            className="ripple"
